...
module.exports = function(grunt) {
    ...
    grunt.registerTask('build_dev', ['adaptive-clean_build','lint:dev','adaptive-compile-css__dev','adaptive-build_dev']);
    grunt.registerTask('build_prod', ['adaptive-clean_build','lint:prod','adaptive-compile-css__prod','adaptive-build_prod']);
    grunt.registerTask('preview', ['build_dev','adaptive-preview']);
    grunt.registerTask('push', ['adaptive-clean_build','lint:prod','adaptive-compile-css__prod','adaptive-push']);
    grunt.registerTask('test', ['build_dev', 'adaptive-test']);
    grunt.registerTask('test_ci', ['build_dev', 'adaptive-test_ci']);
